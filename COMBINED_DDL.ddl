...
alter table CUSTOMER add constraint C_CUSTOMER_FNAME check (C_FNAME=upper (C_FNAME));

alter table CUSTOMER add constraint C_CUSTOMER_LNAME check (C_LNAME=upper (C_LNAME));

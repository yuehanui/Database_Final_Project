...
<!-- Define Title -->
<?php $page_title = 'Pauchase Home Insurance'; ?>

<!-- Common header for all pages -->
<?php include(SHARED_PATH . '/header.php') ?>

<!-- If user already purchase home insurance, redirect to dashboard.php-->
<?php 
	...
	if ($c_type == 'H' or $c_type == 'AH'){
		echo ('<br><div class="text-center"><h4>You already purchased home insurance.</h4></div>');
